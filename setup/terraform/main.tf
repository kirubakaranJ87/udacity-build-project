...
# Create secondary public subnet (Required for EKS Multi-AZ requirement)
...
# EKS Node Group
##################
# Track latest release for Kubernetes 1.30+ using Amazon Linux 2023
...
# Attached AWS Managed Policy to avoid lab role iam:PutUserPolicy permission failure
resource "aws_iam_user_policy_attachment" "github_action_user_policy" {
